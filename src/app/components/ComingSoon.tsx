      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            AI-Powered <span className="bg-gradient-to-r from-yellow-400 to-pink-400 bg-clip-text text-transparent">Solutions</span>
          </h2>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-12 border border-white/20 text-center">
          ...
          <div className="max-w-md mx-auto">
            <div className="flex gap-3">
              ...
              />
              <button className="px-8 py-3 bg-gradient-to-r from-yellow-400 to-pink-400 text-indigo-900 font-semibold rounded-full hover:shadow-2xl transition-all">
                Notify Me
              </button>
            </div>
          </div>
